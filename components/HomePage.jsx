...
class HomePage extends Component {
  ...
  componentDidMount() {
    // Only run this in the client-side browser
    if (typeof window !== "undefined") {
      // Any browser-specific logic can be placed here
      // For example, animations or external libraries that require 'window' or 'self'
    }
  }
  ...
  // Your logic remains unchanged here
  symptomInfoCallback = (data, data2) => {
    this.setState({
      disease_possibility: data,
      user_symptoms: data2,
